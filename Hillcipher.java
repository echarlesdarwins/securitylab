...
System.out.println("deterrr:" + dtrmnt);
if ( dtrmnt < 0 )
dtrmnt = dtrmnt + 26;
...
//System.out.println("transkey["+x+"]["+y+"]"+transkey[x][y]);
//System.out.println("temp["+p+"]["+q+"]"+temp[p][q]);
q++;
if ( q == 2)
{
q=0;
...
//System.out.println("minormat["+i+"]["+j+"]"+minormat[i][j]);
